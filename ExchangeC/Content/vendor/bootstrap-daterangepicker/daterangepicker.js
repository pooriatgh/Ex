...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        show: function(e) {
            ...
            this.oSFTartDate = this.startDate.clone();
        ...
        hide: function(e) {
            ...
            if (!this.endDate) {
                this.startDate = this.oSFTartDate.clone();
                this.endDate = this.oldEndDate.clone();
            }

            //if a new date range was selected, invoke the user callback function
            if (!this.startDate.isSame(this.oSFTartDate) || !this.endDate.isSame(this.oldEndDate))
        ...
        clickCancel: function(e) {
            this.startDate = this.oSFTartDate;
